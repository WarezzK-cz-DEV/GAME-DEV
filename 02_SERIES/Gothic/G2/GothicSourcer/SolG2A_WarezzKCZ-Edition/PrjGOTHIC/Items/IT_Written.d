...
instance ITWR_SMITHMASTERBOOK_LVL1(C_ITEM)
{
	...
	scemename = "MAP";
	description = name;
	text[3] = "This book contains information on improving your blacksmith's skills.";
	text[5] = NAME_VALUE;
	count[5] = value;
...
func void usesmithmasterbook_lvl1()
{
	...
	Doc_PrintLine(ndocid,0,"");
	Doc_PrintLine(ndocid,0,"");
	Doc_PrintLines(ndocid,0,"This old tome contains information about forging weapons.");
	Doc_PrintLines(ndocid,0,"Some knowledge is required to understand it.");
	Doc_PrintLine(ndocid,0,"");
...
instance ITWR_SMITHMASTERBOOK_LVL2(C_ITEM)
{
	...
	description = name;
	text[3] = "This book contains information on improving your blacksmith's skills.";
	text[4] = "Requires knowledge of the previous volume.";
	text[5] = NAME_VALUE;
	count[5] = value;
...
func void usesmithmasterbook_lvl2()
{
	...
	Doc_PrintLine(ndocid,1,"");
	Doc_PrintLine(ndocid,1,"Bastard sword:");
	Doc_PrintLines(ndocid,1,"The blade can be serrated to inflict more damage at a cost of increased weight.");
	Doc_PrintLine(ndocid,1,"");
	Doc_PrintLine(ndocid,1,"Flamberge:");
	Doc_PrintLines(ndocid,1,"The blade can be reforged to add serrated edges making it easier to penetrate armor but, in return, adding more weight.");
