...
func void dia_selivan_teach_enchanting_info()
{
	...
	else if((PLAYER_TALENT_ENCHANTING[1] == FALSE) && (PLAYER_TALENT_ENCHANTING[0] == TRUE) && (KAPITEL >= 3))
	{
	...
	else if((PLAYER_TALENT_ENCHANTING[2] == FALSE) && (PLAYER_TALENT_ENCHANTING[0] == TRUE) && (PLAYER_TALENT_ENCHANTING[1] == TRUE) && (KAPITEL >= 5))
	{
