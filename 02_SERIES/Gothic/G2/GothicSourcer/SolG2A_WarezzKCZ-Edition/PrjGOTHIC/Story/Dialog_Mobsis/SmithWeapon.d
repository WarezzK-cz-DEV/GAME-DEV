...
{
	if((Npc_HasItems(self,itat_shadowfur) >= 5) && (Npc_HasItems(self,itmi_zeitspalt_addon) >= 4) && (Npc_HasItems(self,itmi_textile) >= 5) && (Npc_HasItems(self,itmi_leather) >= 15) && (Npc_HasItems(self,itmi_steelbar) >= 12))
	{
...
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_SMITHARMOR) && (KNOWS_W2KNIGHT_GRD5TO7 == TRUE) && (GRDARMOR == TRUE) && (Npc_HasItems(hero,itar_w2_tknight_grd4) == TRUE) && (PLAYER_TALENT_ARMOR[2] == TRUE))
	{
		return TRUE;
	};
};
...
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_SMITHARMOR) && (KNOWS_W2KNIGHT_GRD5TO7 == TRUE) && (GRDARMOR == TRUE) && (Npc_HasItems(hero,itar_w2_tknight_grd5) == TRUE) && (PLAYER_TALENT_ARMOR[2] == TRUE))
	{
		return TRUE;
	};
};
...
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_SMITHARMOR) && (KNOWS_W2KNIGHT_GRD5TO7 == TRUE) && (GRDARMOR == TRUE) && (Npc_HasItems(hero,itar_w2_tknight_grd6) == TRUE) && (PLAYER_TALENT_ARMOR[2] == TRUE))
	{
		return TRUE;
	};
};
...
{
	if((Npc_HasItems(hero,itat_trollfur) >= 1) && (Npc_HasItems(self,itmi_textile) >= 3) && (Npc_HasItems(self,itmi_leather) >= 2) && (Npc_HasItems(self,itmi_steelbar) >= 1))
	{
...
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_SMITHARMOR) && (KNOWS_SLDG3_GRD6TO7 == TRUE) && (GRDARMOR == TRUE) && (Npc_HasItems(hero,itar_sld_g3_grd4) == TRUE) && (PLAYER_TALENT_ARMOR[1] == TRUE))
	{
		return TRUE;
	};
};
...
{
	if((PLAYER_MOBSI_PRODUCTION == MOBSI_SMITHARMOR) && (KNOWS_SLDG3_GRD6TO7 == TRUE) && (GRDARMOR == TRUE) && (Npc_HasItems(hero,itar_sld_g3_grd5) == TRUE) && (PLAYER_TALENT_ARMOR[1] == TRUE))
	{
		return TRUE;
	};
};
...
instance PC_ITMW_SOT_NS(C_INFO)
{
	...
	permanent = TRUE;
	description = "Assemble 'Sword Of Truth' (1x steel bar, 1x leather)";
};
...
instance PC_ITMW_FINEBASTARD_NS(C_INFO)
{
	...
	permanent = TRUE;
	description = "Assemble 'Fine bastard sword' (1x steel bar, 1x leather)";
};
...
instance PC_ITMW_ANDURIL_NS(C_INFO)
{
	...
	permanent = TRUE;
	description = "Assemble 'Elegant bastard sword' (1x steel bar, 1x leather)";
};
...
instance PC_ITMW_FLAMEBERGE_NS(C_INFO)
{
	...
	permanent = TRUE;
	description = "Assemble 'Flamberge' (2x steel bars, 2x leather)";
};
...
instance PC_ITMW_1H_SPECIAL_01_NS(C_INFO)
{
	...
	permanent = TRUE;
	description = "Assemble 'Ore longsword' (1x steel bar, 1x leather)";
};
...
instance PC_ITMW_2H_SPECIAL_01_NS(C_INFO)
{
	...
	permanent = TRUE;
	description = "Assemble 'Ore two-hander' (1x steel bar, 1x leather, 1x textile)";
};
...
instance PC_ITMW_2H_SPECIAL_04_NS(C_INFO)
{
	...
	permanent = TRUE;
	description = "Assemble 'Large ore Dragonslayer' (2x steel bars, 2x leather, 1x diamond, 1x amethyst)";
};
